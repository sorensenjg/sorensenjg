...
export const metadata = {
  title: "Uses | Justin Sorensen",
  description: "All the things that help me to be comfortable and productive.",
};
      ...
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          <Tool title="16” MacBook Pro, M1 Pro, 16GB RAM (2021)">
            This things is crazy fast, and I&rsquo;ve never once heard the fan.
