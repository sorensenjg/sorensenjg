  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Justin, a web developer who lives and works in the Silicon
          Valley. I’m passionate about cutting edge web tech, great design and
          UX, and performance."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            Valley. I’m passionate about cutting edge web tech, great design and
            UX, and performance. When I’m not working you can find me in the
            Sierra Nevada mountains... camping, fishing, and off-roading with my
            family and friends.
          </p>
